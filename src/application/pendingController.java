...
public class pendingController {
    ...
    public void check(ActionEvent event) throws Exception{
        String query_url = "http://localhost:3000/showpending";
        ...
        try {
            ...
            for(int i=0;i<json.length();i++)
            {
                ...
                memid=Integer.toString(jsonObject.getInt("item_id"));
                a=jsonObject.getString("author");
                d=jsonObject.getString("return_date");
                s1=s1+id+"\n";
                s2+=memid+"\n";
                s3+=a+"\n";
                s4+=d+"\n";
    ...
    public void generate(ActionEvent event) throws Exception{
            String file = "C:\\Users\\SHIVAM MAHESHWARI\\Desktop\\pending.pdf";
